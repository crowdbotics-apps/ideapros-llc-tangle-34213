...
## Project Structure
    ...
    ├── ideapros_llc_tangle_34213  # Django project configurations
...
1. Clone this repo and `cd ideapros_llc_tangle_34213`
...
2. Clone this repo and `cd ideapros_llc_tangle_34213`
